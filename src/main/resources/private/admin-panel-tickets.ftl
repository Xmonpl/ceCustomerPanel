                    ...
                    <table class="table">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <th>$t.priority</th>
                                    <th>$t.topic</th>
                                    <th>#if( $t.closed == "1")<i class="fas fa-lock" style="color: red;"></i>#{else}<i class="fas fa-unlock" style="color: green;"></i>#end</th>
                                    <th><a href='/account/adminpanel/ticket/$t.getId()'>Więcej</a></th>
                                </tr>
                                #end
                            #end
                        </tbody>
...
<script>
    ...
    function getPreviousPage(){
        ...
        if (page <= 0){
            return "/account/adminpanel/tickets/1";
        }else{
            return "/account/adminpanel/tickets/" + page;
        }
    }
